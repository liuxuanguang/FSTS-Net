...
| Delta-SN6   | SCD  | 7       | train_NewDataset.py | inference_SN6.py       |

## Pretrained Weights

The training weights for each dataset can be downloaded via **Baidu Cloud Disk (百度网盘)**:

- **Download Link:** [https://pan.baidu.com/s/1HsckExXidnd90tt5MxzWAA](https://pan.baidu.com/s/1HsckExXidnd90tt5MxzWAA?pwd=fh26)
- **Extraction Code:** `fh26`
...
# Delta-SN6 dataset (7-class semantic change detection)
