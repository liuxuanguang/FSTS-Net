...
from models.sigma.net_utils import FeatureFusionModule as FFM
from models.sigma.net_utils import FeatureRectifyModule as FRM
import math
import time
from models.sigma.logger import get_logger
from models.vmamba import Backbone_VSSM, CrossMambaFusionBlock, ConcatMambaFusionBlock
...
class vssm_tiny(RGBXTransformer):
    def __init__(self, fuse_cfg=None, **kwargs):
        super(vssm_tiny, self).__init__(
            depths=[2, 2, 9, 2], 
            dims=96,
            pretrained='/home/remote/Liyujie-daima/SGF-Net-master/models/sigma/vssm_tiny_0230_ckpt_epoch_262.pth',
            mlp_ratio=0.0,
            downsample_version='v1',
            drop_path_rate=0.2,
        )
