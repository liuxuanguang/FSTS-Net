...
from GrootV.classification.models.tree_scanning0609 import Tree_SSM, Tree_SSM3D, MTTree_SSM3D
...
class GrootV_3D_orginal(nn.Module):
# lxg: tiny参数为channels=80, depths=[2, 2, 9, 2]
# lxg: small参数为channels=96, depths=[2, 2, 13, 2]
    def __init__(self,
                 in_chans=3,
